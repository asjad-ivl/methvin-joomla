...
?><div id="acy_content" style="overflow: auto;">
					...
					<div class="acyblockoptions acypopularlinks">
						...
						<ul>
							<?php foreach($this->mailinglinks as $oneLink){
								...
								echo '<li>'.acymailing_translation_sprintf('NB_USERS_CLICKED_ON', $text, '<a target="_blank" href="'.$oneLink->url.'">'.$urlName.'</a>').'</li>';
							} ?>
						</ul>
					</div>
				<?php } ?>
	...
	<div class="acyblockoptions" style="<?php echo acymailing_isAdmin() ? 'padding-left:0px;padding-right:0px;' : 'padding-left:7px;padding-right:7px;'; ?>">
