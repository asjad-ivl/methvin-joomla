...
class fieldsClass extends acymailingClass{
	...
	private function _displayBirthday($field, $value, $map, $inside){
		...
		$months[] = acymailing_selectOption('01', acymailing_translation('JANUARY'));
		$months[] = acymailing_selectOption('02', acymailing_translation('FEBRUARY'));
		$months[] = acymailing_selectOption('03', acymailing_translation('MARCH'));
		$months[] = acymailing_selectOption('04', acymailing_translation('APRIL'));
		$months[] = acymailing_selectOption('05', acymailing_translation('MAY'));
		$months[] = acymailing_selectOption('06', acymailing_translation('JUNE'));
		$months[] = acymailing_selectOption('07', acymailing_translation('JULY'));
		$months[] = acymailing_selectOption('08', acymailing_translation('AUGUST'));
		$months[] = acymailing_selectOption('09', acymailing_translation('SEPTEMBER'));
		$months[] = acymailing_selectOption('10', acymailing_translation('OCTOBER'));
		$months[] = acymailing_selectOption('11', acymailing_translation('NOVEMBER'));
		$months[] = acymailing_selectOption('12', acymailing_translation('DECEMBER'));
		$dayField = acymailing_select($days, $map.'[day]', $class.' style="max-width:80px;" title="'.$this->trans('ACY_DAY').'"', 'value', 'text', @$vals[2], $this->prefix.$field->namekey.$this->suffix.'_day');
		$monthField = acymailing_select($months, $map.'[month]', $class.' style="max-width:130px;" title="'.$this->trans('ACY_MONTH').'"', 'value', 'text', @$vals[1], $this->prefix.$field->namekey.$this->suffix.'_month');
		$yearField = acymailing_select($years, $map.'[year]', $class.' style="max-width:100px;" title="'.$this->trans('ACY_YEAR').'"', 'value', 'text', intval(@$vals[0]), $this->prefix.$field->namekey.$this->suffix.'_year');
