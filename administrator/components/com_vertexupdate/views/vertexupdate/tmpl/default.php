...
if (file_exists(JPATH_COMPONENT_ADMINISTRATOR . "/update.zip")) {
    $update_exists = true;
    $vertexxml = simplexml_load_file("zip://" . JPATH_COMPONENT_ADMINISTRATOR . "/update.zip#xml/Vertex.xml");//file_get_contents("zip://" . JPATH_COMPONENT_ADMINISTRATOR . "/update.zip#xml/Vertex.xml");
    if ($vertexxml) {
