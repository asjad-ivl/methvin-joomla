...
$enable_folder_move = $_SESSION['TFU']["ENABLE_FOLDER_MOVECOPY"];  
$enable_file_copymove = $_SESSION['TFU']["ENABLE_FILE_MOVECOPY"];
...
// new 2.17
$smtp_port= intval($_SESSION['TFU']['SMTP_PORT']);
