	...
	private function _addScript($id, $moduleNumber){
		...
		<script type="text/javascript">
			...
			function countCharacters(moduleNumber){
				...
				var message_body = message_body.replace(/&amp;/g, '&');

				var gsm7bitChars = "£¥èéùìòÇØøÅåΔ_ΦΓΛΩΠΨΣΘΞÆæßÉ !\"#¤%'()*+,-./0123456789:;<=>?¡ABCDEFGHIJKLMNOPQRSTUVWXYZÄÖÑÜ§¿abcdefghijklmnopqrstuvwxyzäöñüà";
				var gsm7bitExChar = "^{}\\[~]|€@\n\r$&¨";
				var gsm7bitUnits = 0;
