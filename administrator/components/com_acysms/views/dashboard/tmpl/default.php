...
?><div id="acysms_content">
	...
	<div id="dashboard_mainview">
		...
		if(!empty($this->contentToDisplay) && $this->config->get('dashboardnews', 0) < strtotime($this->contentToDisplay->date)){
			...
			$notremind = '<small style="float:right;margin-right:30px;position:relative;">' . $toggleHelper->delete('acydashboard_specialcontent', 'dashboardnews_'.strtotime($this->contentToDisplay->date), 'config', false, JText::_('SMS_DONT_REMIND')) . '</small>';

			echo '<div class="acydashboard_specialcontent acysmsonelineblockoptions" id="acydashboard_specialcontent">'.$notremind;
			if(!empty($this->contentToDisplay->title)) echo '<span class="acysmsblocktitle">'.$this->contentToDisplay->title.'</span>';
	...
	<div id="acysmsdashboard_progress">
		<div class="acysmsdashboard_progressbar">
			<table width="100%">
				<tr>
					<td>
						<svg class="green-icon mail-icon <?php echo(!empty($this->progressBar->createSender) ? 'acystepdone' : ''); ?>" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 126.1 78.2"><title>acysms logo SVG</title>
							<polygon points="7.7 0 116.7 0 62.2 45.1 7.7 0"/>
							<polygon points="0 5.6 0 74.2 40.5 39.1 0 5.6"/>
							<polygon points="45.8 45.1 7.7 78.2 116.7 78.2 78.6 45.1 62.2 58.2 45.8 45.1"/>
							<polygon points="126.1 5.6 86.3 38.5 126.1 74.2 126.1 5.6"/>
						</svg>
					</td>
					<td>
						<svg class="blue-icon mail-icon <?php echo(!empty($this->progressBar->selectIntegration) ? 'acystepdone' : ''); ?>" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 126.1 78.2"><title>acysms logo SVG</title>
							<polygon points="7.7 0 116.7 0 62.2 45.1 7.7 0"/>
							<polygon points="0 5.6 0 74.2 40.5 39.1 0 5.6"/>
							<polygon points="45.8 45.1 7.7 78.2 116.7 78.2 78.6 45.1 62.2 58.2 45.8 45.1"/>
							<polygon points="126.1 5.6 86.3 38.5 126.1 74.2 126.1 5.6"/>
					...
					<td>
						<svg class="orange-icon mail-icon <?php echo(!empty($this->progressBar->addUser) ? 'acystepdone' : ''); ?>" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 126.1 78.2"><title>acysms logo SVG</title>
							<polygon points="7.7 0 116.7 0 62.2 45.1 7.7 0"/>
							<polygon points="0 5.6 0 74.2 40.5 39.1 0 5.6"/>
							<polygon points="45.8 45.1 7.7 78.2 116.7 78.2 78.6 45.1 62.2 58.2 45.8 45.1"/>
							<polygon points="126.1 5.6 86.3 38.5 126.1 74.2 126.1 5.6"/>
					...
					<td>
						<svg class="red-icon mail-icon <?php echo(!empty($this->progressBar->sendMessage) ? 'acystepdone' : ''); ?>" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 126.1 78.2"><title>acysms logo SVG</title>
							<polygon points="7.7 0 116.7 0 62.2 45.1 7.7 0"/>
							<polygon points="0 5.6 0 74.2 40.5 39.1 0 5.6"/>
							<polygon points="45.8 45.1 7.7 78.2 116.7 78.2 78.6 45.1 62.2 58.2 45.8 45.1"/>
							<polygon points="126.1 5.6 86.3 38.5 126.1 74.2 126.1 5.6"/>
