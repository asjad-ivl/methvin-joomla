...
?><div id="acysms_content">
	...
	<form action="<?php echo JRoute::_('index.php?option='.ACYSMS_COMPONENT.'&ctrl='.JRequest::getCmd('ctrl')); ?>" method="post" name="adminForm" id="adminForm">
			...
			for($i = 0, $a = count($this->rows); $i < $a; $i++){
				...
				<tr class="<?php echo "row$k"; ?>">
					...
					<?php if(ACYSMS_J30){ ?>
						<td class="order">
							<?php $iconClass = '';
							if(!$saveOrder) $iconClass = ' inactive tip-top hasTooltip" title="'.JText::_('JORDERINGDISABLED'); ?>
