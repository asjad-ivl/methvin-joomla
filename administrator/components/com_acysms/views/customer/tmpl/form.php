		...
		<table class="acysms_blocktable" width="100%">
			...
			<tr>
				...
				<td>
					...
					$values = array();
					if(isset($this->customer->customer_senderprofile_id) && is_string($this->customer->customer_senderprofile_id) && strlen($this->customer->customer_senderprofile_id) > 0) $values = explode(',', $this->customer->customer_senderprofile_id);
