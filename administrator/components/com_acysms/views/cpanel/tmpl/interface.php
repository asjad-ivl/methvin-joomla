...
?><div id="config_interface">
	...
	<div class="acysmsonelineblockoptions">
		...
		<table class="acysms_blocktable" cellspacing="1">
			...
			<?php if(!empty($this->synchusers)){ ?>
			<tr>
				<td class="key">
					<?php echo JText::_('SMS_LINK_JUSERS'); ?>
				</td>
				<td>
					<?php echo $this->synchusers; ?>
				</td>
			</tr>
			<?php } ?>
		</table>
	...
	<div class="acysmsonelineblockoptions">
		...
		<table class="acysms_blocktable" cellspacing="1">
			...
			<tr>
				<td class="key">
					<?php echo ACYSMS::tooltip(JText::_('SMS_OWN_GROUPS_DESC'), JText::_('SMS_USER_OWN_GROUPS'), '', JText::_('SMS_USER_OWN_GROUPS')); ?>
				</td>
				<td>
					<?php echo JHTML::_('acysmsselect.booleanlist', "config[only_own_groups]", '', $this->config->get('only_own_groups', true)); ?>
				</td>
			</tr>
		</table>
	</div>
