...
class ACYSMSqueueHelper{
	...
	public function process(){
		...
		foreach($queueElements as $oneQueue){
			...
			if($useShortUrl != 0) $dispatcher->trigger('onACYSMSReplaceUrl', array(&$myMessage, false));
			...
			$this->senderProfiles[$myMessage->message_senderprofile_id]->fullMessage->smsid = $myresult->smsid;
