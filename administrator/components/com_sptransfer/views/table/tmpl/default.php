...
<form action="<?php echo JRoute::_('index.php?option=com_sptransfer&amp;view=table&amp;layout=default&amp;tmpl=component&amp;prefix=' . $this->prefix . '&amp;name=' . $this->name); ?>" method="post" name="adminForm" id="adminForm">
