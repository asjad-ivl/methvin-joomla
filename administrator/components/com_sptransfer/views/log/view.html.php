 ...
 * @since		1.6
 */
class SpTransferViewLog extends JViewLegacy
{
	protected $items;
	...
	protected function addToolbar()
	{
		...
		if ($canDo->get('core.admin')) 
		{
                    ...
                    if ($canDo->get('core.delete')) {
                            $bar->appendButton('Confirm','COM_SPTRANSFER_CONFIRM_MSG', 'delete', 'COM_SPTRANSFER_LOG_DELETE_INDIVIDUAL', 'log.delete_ind',true);
                            $bar->appendButton('Confirm','COM_SPTRANSFER_CONFIRM_MSG', 'delete', 'COM_SPTRANSFER_LOG_DELETE_MASS', 'log.delete',false);
                    }			
