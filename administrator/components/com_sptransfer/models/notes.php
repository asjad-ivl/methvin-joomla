 ...
 * @since       2.5
 */
class SPTransferModelNotes extends JModelList
{
	/**
	 * Class constructor.
	 *
	 ...
	 *
	 * @return  JDatabaseDriverQuery  A JDatabaseDriverQuery object to retrieve the data set.
	 *
	 * @since   2.5
	 */
    ...
    public function getCategories() {
        ...
        $query->join('INNER', '#__user_notes AS co ON co.catid = ca.id');
