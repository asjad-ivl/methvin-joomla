-----------------------------------------------------------------
JFUploader 3.2.5 - PLUGIN - README
...
Web Server: Joomla >= 3.x, php > 4.x with gdlib > 2.0
Joomla:     JFUploader component installed

Installation
------------
Make sure you have the JFUploader Component installed.
Then install the zip file as a plugin in the Joomla backend.
 
License
-------
Please note that 2 licenses affect this software bundle.
The Joomla Flash Uploader is bridge between Joomla and the 
