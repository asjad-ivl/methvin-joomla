/* Based on jquery Tocify - v1.3.0 - 2012-02-23 by Greg Franko     http://www.gregfranko.com/jquery.tocify.js/
* http://dbycreative.net
* Copyright (c) 2013 DBY Creative
* NOTE - you can't just copy past newer versions of Greg's tocify because a lot of things have been modified to be more bootstrap / joomla compliant.
*/
    ...
    $.widget("toc.tocify", {
        ...
        _generateToc: function() {
            ...
            var self = this,
             ...
             if(this.options.selectors.indexOf(",") !== -1) {
                 ...
                 firstElem = $(this.options.context).find(this.options.selectors.replace(/ /g,"").substr(0, this.options.selectors.indexOf(","))+":not(.dont-index)");
             ...
             // If the selectors option does not have a comman within the string
                 ...
                 firstElem = $(this.options.context).find(this.options.selectors.replace(/ /g,"")+":not(.dont-index)");
            ...
            firstElem.each(function(index) {
                ...
                $(this).nextUntil(this.nodeName.toLowerCase()).each(function() {
                    ...
                    // If there are nested subheader elements
                        ...
                        // Loops through all of the subheader elements
                        $(this).find(self.options.selectors).not('.dont-index').each(function() {
            ...
            if(self.options.addRule) firstElem.not(":first").before($('<hr class="no-height"/>'));
            self.element.find('ul.sub-header a').wrap('<li/>'); //rough hack to create proper bootstrap compliant structure ::Vik
        },
        ...
        _setActiveElement: function() {
            ...
            var self = this,
                ...
                elem = self.element.find("a[data-unique='" + hash + "']").parent();
        ...
        _appendSubheaders: function(self, li) {
            ...
            if((+$(this).prop("tagName").charAt(1) < +previousHeader.prop("tagName").charAt(1))) {
                ...
                self.element.find(".sub-header").last().after(self._nestElements($(this), index).wrap("<li/>"));
            ...
            // If the current header DOM element is the same type of header(eg. h4) as the previous header DOM element
                ...
                li.find(".item").last().after(self._nestElements($(this), index).wrap("<li/>"));
       ...
       // _setEventHandlers
        ...
        _setEventHandlers: function() {
            ...
            this.element.on("click.tocify", "a", function(event) {
                ...
                if(self.options.showAndHide) {
                    ...
                    var elem = $('a[data-unique="' + $(this).attr("data-unique") + '"]');
                    ...
                    setTimeout(function() {
                        ...
                        $(self.options.context).find("div[data-unique]").next().each(function() {
                            ...
                            if ((Math.abs($(this).offset().top - winScrollTop) < self.options.highlightOffset)) {
                                ...
                                elem = $('a[data-unique="' + $(this).prev("div[data-unique]").attr("data-unique") + '"]');
        ...
        _addCSSClasses: function() {
            ...
            if(this.options.theme === "jqueryUI") {
                ...
                this.element.addClass("ui-widget").find(".toc-title").addClass("ui-widget-header").end().find("a").addClass("ui-widget-content");
            ...
            // If the user wants a twitterBootstrap theme
                ...
                this.element.addClass("nav nav-list");
