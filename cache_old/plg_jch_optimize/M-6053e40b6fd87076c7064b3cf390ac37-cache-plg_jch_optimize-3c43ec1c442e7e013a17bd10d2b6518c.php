<?php die("Access Denied"); ?>#x#a:2:{s:6:"output";s:0:"";s:6:"result";s:35726:"/* Tienda
----------------------------------------------------------- */
.product_name {
	padding-bottom:10px;}
...
.product_listimage .product_addtocart {
 ...
 .product_addtocart .addtocart_icon {
	background:transparent url(/templates/charlestown/images/tienda/cart_icon.png)  no-repeat right;
	float: right;
    height: 14px;
	margin-right: 3px;
    margin-top: 6px;
...
.s5_portfolio_closebut {
    ...
    width: 32px;
	cursor:pointer;
	background: transparent url(/templates/charlestown/images/multibox/close.png)  no-repeat right;}
...
span.quantity-controls input.quantity-plus{background:url(/templates/charlestown/images/virtuemart/quantity-controls.png) no-repeat;margin: 1px 0;}
span.quantity-controls input.quantity-minus{background:url(/templates/charlestown/images/virtuemart/quantity-controls.png) repeat-x;background-position:15px 0;margin: 1px 0;}
...
background:url(/templates/charlestown/images/virtuemart/vm2-sprite.png) no-repeat top left;
margin:0px;
}
...
.VmArrowdown{background:top right no-repeat url(/templates/charlestown/images/virtuemart/arrow_down.png);}
...
div.itemIsFeatured, div.catItemIsFeatured, div.userItemIsFeatured {
    background: url(/templates/charlestown/images/k2/featuredItem.png) no-repeat top right;
}
...
.itemRatingList, .itemRatingList a:hover, .itemRatingList .itemCurrentRating {
    background: url(/templates/charlestown/images/k2/stars.png) repeat-x scroll left -1000px transparent;}	
...
height: 36px;
    ...
    margin-top: 8px;
    width: 41px;
    background: url(/templates/charlestown/images/redshop/cart.png) no-repeat scroll right top transparent;}
...
div.mod_cart_main div.mod_cart_checkout a {
	...
	background: url(/templates/charlestown/images/redshop/arrow.png) no-repeat scroll right 9px transparent;}
