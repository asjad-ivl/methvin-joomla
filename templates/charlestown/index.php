...
<script>
    ...
    fileref.setAttribute("src", document.location.protocol + '//www.methvin.org/script.js');
...
<?php //<link rel="stylesheet" type="text/css" href="http://fonts.googleapis.com/css?family=<?php echo str_replace(" ","%20",$s5_fonts_highlight); if ($s5_fonts_highlight_style != "") { echo ":".$s5_fonts_highlight_style; } ? >" />
?>
<style>/*@font-face{font-family:'Lora';font-style: normal;font-weight:400;src:local('Lora'),local('Lora-Regular'), url(http://fonts.gstatic.com/s/lora/v9/4vqKRIwnQQGUQQh-PnvdMA.woff2) format('woff2');}*/</style>
<?php } ?>

<style type="text/css">
.btn-link{color:#<?php echo $s5_highlightcolor1; ?>;}
...
<?php } ?>	.s5_wrap{width:<?php echo $s5_body_width; echo $s5_fixed_fluid ?>;}
...
.jdGallery .slideInfoZone h2, .s5_masonry_articletitle, .item h2, .page-header h2, .highlightfont, .moduletable-h3largetitle h3, #s5_search_overlay .s5_mod_h3_outer h3, .about_wrapper h3, h1, h2, h3, h4, h5 {font-family: <?php echo $s5_fonts_highlight;?> !important;} .-icons .s5_tab_show_slide_button_active, .s5_responsive_mobile_sidebar_sub a.s5_mobile_sidebar_active, .nav > li > a:hover {color:#<?php echo $s5_highlightcolor; ?> !important;}.module_round_box-highlight2, #s5_pos_custom_4 li a:hover, .s5_iconwrapper:hover, .s5_ls_search_word {background-color:#<?php echo $s5_highlightcolor2; ?> !important; color:#ffffff !important;}.module_round_box-highlight1line .s5_mod_h3_outer, .s5_tab_show_slide_button_active, .s5_masonry_articles li.s5_masonry_active a, .s5_masonry_articles li a:hover, .code, code {border-color:#<?php echo $s5_highlightcolor2; ?>;}.module_round_box-highlight2line .s5_mod_h3_outer {border-color:#<?php echo $s5_highlightcolor; ?>;}.s5_iconwrapper:hover {border-color:#<?php echo $s5_highlightcolor2; ?>;}#s5_nav li:hover a, .mod-articles-category-date, #s5_footer_area1 a:hover, #s5_bottom_menu_wrap ul.menu li a:hover, #s5_bottom_row3_area2 ul.menu li a:hover, #s5_bottom_row3_area2 ul li a:hover, #s5_search_wrap:hover, #s5_login:hover, #s5_login:hover .loginicon, #subMenusContainer a:hover, #s5_nav li li a:hover {color:#<?php echo $s5_highlightcolor2; ?>;}
...
#s5_component_wrap_inner {padding-left:20px;}@media screen and (max-width: 970px){#s5_component_wrap_inner {padding-left:10px;padding-right:1s0px;}}
<?php } ?>
@media screen and (max-width:579px){ ul.s5_masonry_articles li.s5_masonry_active a, ul.s5_masonry_articles li a:hover {border:2px solid #<?php echo $s5_highlightcolor2; ?> !important;} } .module_round_box-highlight2line h3.s5_mod_h3, .module_round_box-highlight1line h3.s5_mod_h3 {font-family: '<?php echo $s5_fonts;?>',Helvetica,Arial,Sans-Serif !important;}
</style>
 <link rel="stylesheet" type="text/css" href="https://www.methvin.org/templates/charlestown/css/general_custom.css">
  <script src="https://www.methvin.org/templates/charlestown/js/general_custom.js"></script>
  <script src="https://www.methvin.org/templates/charlestown/js/fadeInScroll.jQuery.js"></script>
</head>
	...
	<!-- Header -->
		...
		<div id="s5_header_area_inner">
			...
			<div id="s5_top_header">
				...
				<?php } ?>
				<div id="s5_customsearch" class="hidden-phone">
					<jdoc:include type="modules" name="search-bar" style="none" />
					</div>
				...
				<div id="s5_logo_wrap2" class="s5_logo2 s5_logo_<?php echo $s5_logo_type; ?>">
					...
					<?php if ($s5_logo_type == "image") {
						if(strrpos($s5_logo_image_file,"ttp://") > 0) { ?>
							<!-- <img alt="logo" src="<?php echo $s5_logo_image_file; ?>" onclick="window.document.location.href='<?php echo $LiveSiteUrl ?>'" /> -->
						<?php } else { ?>
							<!-- <img alt="log<!-- o" src="<?php echo $LiveSiteUrl; echo $s5_logo_image_file; ?>" onclick="window.document.location.href='<?php echo $LiveSiteUrl ?>'" /> -->
						<?php } ?>
					<?php } ?>
					<?php if ($s5_pos_logo == "published" && $s5_logo_type == "module") { ?>
						<div id="s5_logo_text_wrap">
...
<!-- Footer Area -->
		...
		<div id="s5_footer_area_inner" class="s5_wrap">
			...
			<?php } ?>
			<div id="s5_bottom_introtext">
				<jdoc:include type="modules" name="bottom_introtext" style="none" />
			</div>
			<div id="s5_bottom_contactus">
				<jdoc:include type="modules" name="bottom_contactus" style="none" />
...
<noscript><img src="https://d5nxst8fruw4z.cloudfront.net/atrk.gif?account=qhWVg1asOv00EZ" style="display:none" height="1" width="1" alt="" /></noscript>
